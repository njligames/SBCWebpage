...
header "Phidgets" "Logging" "Phidget Logging" "$SCRIPT_NAME"
...
if equal "$running" "Stopped"; then
	startstop="Logging is <span style=\"color:red\">stopped</span>... <input type=\"submit\" value=\"Start\" name=\"startstop\" />"
else
	startstop="Logging is <span style=\"color:green\">running</span>... <input type=\"submit\" value=\"Stop\" name=\"startstop\" />"
fi

display_form <<EOF
start_form|Phidget Logging
field|
...
<!--
##WEBIF:name:Phidgets:200:Logging
-->
